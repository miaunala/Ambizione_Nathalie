...
# for local
base_path = "../Ambizione Nathalie/Influencers and Fake News/Claim_Matching_UZH/data/"
claims_csv = pd.read_csv(base_path + "analysis_claims_df.csv")
posts_csv = pd.read_csv(base_path + "analysis_posts_df.csv")

'''
# for cluster
claims_csv = pd.read_csv("../data/analysis_claims_df.csv")
posts_csv = pd.read_csv("../data/analysis_posts_df.csv")
'''
...
output_path_r1 = "../data/flat_pairs_bm25_r1.csv"  # [claim_date-28d, claim_date]
output_path_r2 = "../data/flat_pairs_bm25_r2.csv"  # [claim_date, claim_date+28d]
